...
class TextDiffToolTest {
    ...
    void singleLineChanged() {
        String result = TextDiffToolFx.diff("hello", "world");
    ...
    void multipleChanges() {
        String result = TextDiffToolFx.diff("a\nb\nc", "a\nx\nc");
    ...
    void emptyOriginal() {
        String result = TextDiffToolFx.diff("", "new content");
    ...
    void emptyRevised() {
        String result = TextDiffToolFx.diff("old content", "");
    ...
    void bothEmpty() {
        String result = TextDiffToolFx.diff("", "");
        assertThat(result).isEqualTo("(no differences)");
    }
}
