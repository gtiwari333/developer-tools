...
@DisplayName("UuidGeneratorToolFx static methods")
class UuidGeneratorToolTest {

    @Test @DisplayName("generateV4 produces valid UUID format")
    void v4Format() {
        String uuid = UuidGeneratorToolFx.generateV4();
    ...
    void v4Unique() {
        ...
        for (int i = 0; i < 100; i++) {
            assertThat(seen.add(UuidGeneratorToolFx.generateV4())).isTrue();
        }
    }

    @Test @DisplayName("generateV3 produces valid UUID format")
    void v3Format() {
        String uuid = UuidGeneratorToolFx.generateV3("namespace", "name");
    ...
    void v3Deterministic() {
        String a = UuidGeneratorToolFx.generateV3("ns", "name");
        String b = UuidGeneratorToolFx.generateV3("ns", "name");
        assertThat(a).isEqualTo(b);
    }

    @Test @DisplayName("generateV3 different namespaces produce different UUIDs")
    void v3DifferentNamespace() {
        String a = UuidGeneratorToolFx.generateV3("ns-a", "name");
        String b = UuidGeneratorToolFx.generateV3("ns-b", "name");
        assertThat(a).isNotEqualTo(b);
    }

    @Test @DisplayName("generateV1 produces valid UUID format")
    void v1Format() {
        String uuid = UuidGeneratorToolFx.generateV1();
    ...
    void v6Format() {
        String uuid = UuidGeneratorToolFx.generateV6();
    ...
    void v7Format() {
        String uuid = UuidGeneratorToolFx.generateV7();
