...
@DisplayName("TextStatisticsToolFx.computeStats")
class TextStatisticsToolTest {

    @Test
    @DisplayName("returns null for empty input")
    void emptyInputReturnsNull() {
        assertThat(TextStatisticsToolFx.computeStats("")).isNull();
    }

    @Test
    @DisplayName("counts characters including spaces")
    void charCount() {
        var stats = TextStatisticsToolFx.computeStats("hello world");
    ...
    void wordCount() {
        var stats = TextStatisticsToolFx.computeStats("hello world foo bar");
    ...
    void wordCountWhitespaceOnly() {
        var stats = TextStatisticsToolFx.computeStats("   ");
    ...
    void uniqueWordCount() {
        var stats = TextStatisticsToolFx.computeStats("a b a c b a");
    ...
    void lineCount() {
        var stats = TextStatisticsToolFx.computeStats("line1\nline2\nline3");
    ...
    void singleLine() {
        var stats = TextStatisticsToolFx.computeStats("hello");
    ...
    void byteCount() {
        var stats = TextStatisticsToolFx.computeStats("abc");
    ...
    void multiByteUtf8() {
        var stats = TextStatisticsToolFx.computeStats("héllo");
