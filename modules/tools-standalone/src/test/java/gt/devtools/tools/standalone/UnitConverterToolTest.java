...
@DisplayName("UnitConverterToolFx static methods")
class UnitConverterToolTest {

    @Test @DisplayName("convertDataSize: base-1024 conversion")
    void dataSize1024() {
        var result = UnitConverterToolFx.convertDataSize(1024, 1024);
    ...
    void dataSize1000() {
        var result = UnitConverterToolFx.convertDataSize(1000, 1000);
    ...
    void dataSizeZero() {
        var result = UnitConverterToolFx.convertDataSize(0, 1024);
    ...
    void numberBasesZero() {
        var result = UnitConverterToolFx.convertNumberBases(0);
