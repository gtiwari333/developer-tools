...
public final class UrlBase64EncoderDecoderFx extends EncoderDecoderFx {
    ...
    public static byte[] encode(byte[] input) { return Base64.getUrlEncoder().encode(input); }
    public static byte[] decode(byte[] input) { return Base64.getUrlDecoder().decode(input); }
    public static final class Factory implements ToolFxFactory<UrlBase64EncoderDecoderFx> {
        ...
        @Override public ToolPresentation getPresentation() {
            return ToolPresentation.of("url-base64-encoder-decoder", "URL Base64", "URL Base64 Encoder / Decoder").withGroupId("encoders"); }
