...
public final class MimeBase64EncoderDecoderFx extends EncoderDecoderFx {
    ...
    public static byte[] encode(byte[] input) { return Base64.getMimeEncoder().encode(input); }
    public static byte[] decode(byte[] input) { return Base64.getMimeDecoder().decode(input); }
    public static final class Factory implements ToolFxFactory<MimeBase64EncoderDecoderFx> {
        ...
        @Override public ToolPresentation getPresentation() {
            return ToolPresentation.of("mime-base64-encoder-decoder", "MIME Base64", "MIME Base64 Encoder / Decoder").withGroupId("encoders"); }
